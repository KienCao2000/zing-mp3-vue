<template>
  <div class="z-home" id="z-home">
    ...
    <div v-if="getNewReleaseObj && getNewReleaseObj['all'].length" class="mb-3 suggest-list">
      <list-release :listItem="getNewReleaseObj['all']" />
    </div>
...
<script lang="ts">
  ...
  export default class Home extends Vue {
    ...
    get getNewReleaseObj(): Array<Record<string, any>> {
      const objList = filter(this.data, item => item.sectionType === 'new-release')
      return objList.length > 0 ? objList[0].items : []
    }
